...
export default function TwitterOptions({ options, onChange }: TwitterOptionsProps) {
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="includePoll">Add a poll to this tweet</Label>
                    </div>
                ...
                <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="addLocation">Add location to tweet</Label>
                    </div>
