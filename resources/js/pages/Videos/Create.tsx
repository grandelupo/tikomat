...
import { Upload, Youtube, Instagram, Video as VideoIcon, Calendar, Clock, ArrowLeft, Info, Facebook, Camera, Palette } from 'lucide-react';
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {(errors.video || clientErrors.video) && (
                                    <p className="text-sm text-red-600">{errors.video || clientErrors.video}</p>
                                )}
                                ...
                                {publishType === 'scheduled' && (
                                    <div className="space-y-2">
                                        ...
                                        {(errors.publish_at || clientErrors.publish_at) && (
                                            <p className="text-sm text-red-600">{errors.publish_at || clientErrors.publish_at}</p>
                                        )}
                                    </div>
                                )}
                            </div>
